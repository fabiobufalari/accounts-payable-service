// Path: src/main/java/com/bufalari/payable/converter/PaymentTransactionConverter.java
...
/**
 * Converts between PaymentTransactionEntity and PaymentTransactionDTO.
 * Handles the mapping of fields between the database entity and the data transfer object.
 * Converte entre PaymentTransactionEntity e PaymentTransactionDTO.
...
public class PaymentTransactionConverter {
     ...
     *
     * @param entity The entity object retrieved from the database. / O objeto entidade recuperado do banco de dados.
     * @return The corresponding DTO, or null if the entity is null. / O DTO correspondente, ou null se a entidade for nula.
     */
     ...
     *
     * @param dto The DTO object received from the request or other sources. / O objeto DTO recebido da requisição ou outras fontes.
     * @return The corresponding entity, or null if the DTO is null. / A entidade correspondente, ou null se o DTO for nulo.
     */
    public PaymentTransactionEntity dtoToEntity(PaymentTransactionDTO dto) {
        ...
        return PaymentTransactionEntity.builder()
                .id(dto.getId()) // Usually null for creation, non-null for potential updates (rare)

// Path: src/main/java/com/bufalari/payable/exception/ResourceNotFoundException.java
package com.bufalari.payable.exception; // Ensure correct package

import org.springframework.http.HttpStatus;
import org.springframework.web.bind.annotation.ResponseStatus;

/**
 * Custom exception thrown when a requested resource (like a Payable) is not found.
 * Maps to HTTP 404 Not Found status code.
 * Exceção customizada lançada quando um recurso solicitado (como uma Conta a Pagar) não é encontrado.
